            ...
            <div className="center-muscles">
                ...
                <div className="inline-muscles">
                    ...
                    <button 
                        ...
                        onMouseLeave={() => setImage(0)}
                        onClick={props.displayShoulders}
                    >
                        Shoulders
                    </button>
                ...
                <div className="inline-muscles">
                    ...
                    <button 
                        ...
                        onMouseLeave={() => setImage(0)}
                        onClick={props.displayHamstrings}
                    >
                        Hamstrings
                    </button>
